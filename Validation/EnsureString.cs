...
public class EnsureString
{
    ...
    public EnsureString IsJsonArray(string message = null)
    {
        if (@string.IsJsonArray())
        {
            return this;
        }
        throw new ClientException(message ?? "String is not a valid JSON array");
    }

    public EnsureString IsJsonObject(string message = null)
    {
        if (@string.IsJsonObject())
        {
            return this;
        }
        throw new ClientException(message ?? "String is not a valid JSON object");
    }
    ...
    public EnsureString Contains(string text, string message = null)
    {
        if (@string.Contains(text))
        {
            return this;
        }
        throw new ClientException(message ?? $"{@string} does not contain {text}");
    }
}
