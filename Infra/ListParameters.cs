...
public class ListParameters
{
    ...
    public void AddInFilter<T>(Expression<Func<T, object>> propertySelector, object[] values)
    {
        string property = GetPropertyName(propertySelector);
        AddFilter(new Filter
        {
    ...
    public void AddNotInFilter<T>(Expression<Func<T, object>> propertySelector, object[] values)
    {
        string property = GetPropertyName(propertySelector);
        AddFilter(new Filter
        {
    ...
    public static ListParameters Create()
    {
        ...
        listParameters.PageSize = InfraConfig.DefaultPageSize;
    ...
    public static void ProvideDefaultValues(ListParameters listParameters)
    {
        ...
        listParameters.PageSize = listParameters.PageSize ?? InfraConfig.DefaultPageSize;
